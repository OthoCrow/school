...
# Retrieve winner Ticket Price and Profit (so we can adjust profit numbers accordingly)
ticket_won = mini_movie_frame.at[winner_index, 'Total']
profit_won = mini_movie_frame.at[winner_index, 'Profit']

# Add curency to moneys
...
total_paid_string = f"Total Paid: ${total_paid}"
total_profit_string = f"Total Profit: ${total_profit}"



# Winner announcment
lucky_winner_string = f"\nThe winner is {winner}. Their ticket worth ${ticket_won} is free!"
final_total_paid_string = f"\nTotal paid is now ${total_paid - ticket_won}"
final_total_profit_string = f"Total profit is now ${total_profit - profit_won}"
