...
class Converter():
    ...
    def __init__(self):
        ...
        instructions = "Please enter a temperature below and then press on of the buttons to convert it from Centigrade to Fahrenheit."
        ...
        for item in button_details_list:
            self.make_button = Button(self.button_frame, text=item[0], bg=item[1], fg='#ffffff', font=("Arial", "12", "bold"), width="12", command=item[2])
    ...
    def check_temp(self, min_temp):
        # Checks temperature is valid and either invokes calculation or shows error
        ...
        try:
            ...
            if to_convert >= min_temp:
                ...
                error = f"Cannot enter a number below {min_temp}"
        except ValueError: 
            error = "Please enter a number"
    ...
    def convert(self, min_temp):
        ...
        if min_temp == c.ABS_ZERO_CELSIUS:
            self.answer_error.config(text="Convertin to F")
        else:
            self.answer_error.config(text="Convertin to C")
